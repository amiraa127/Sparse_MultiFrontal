...
namespace smf
{
  ...
  eliminationTree::eliminationTree(const int* colPtr,
				   const int* row_ind,
				   int input_NumCols)
  {
  ...
  eliminationTree::eliminationTree(int input_numCols,
				   int input_numBlocks,
  ...
  void eliminationTree::build_eliminationTree(int input_numCols,
					      int input_numBlocks,
					      const std::vector<int>& rangVec,
					      const std::vector<int>& treeVec)
  {
  ...
  std::vector<int> eliminationTree::createParentVec(const int* colPtr,
						    const int* row_ind,
						    int input_NumCols)
  {
    int n = input_NumCols;
  ...
  std::vector<int> eliminationTree::createRangVec(const std::vector<int> & parentVec,
						  int input_NumCols)
  {
  ...
  std::vector<int> eliminationTree::createTreeVec(const std::vector<int> & parentVec,
						  std::vector<int> & rangVec)
  {
  ...
  void eliminationTree::test(const int* colPtr,
			     const int* row_ind,
			     int input_NumCols)
  {
    std::vector<int> parentVec = createParentVec(colPtr,row_ind,input_NumCols);
  ...
  int eliminationTree::countColsAtLevel(int level, const node* root) const
  {
